...
from fruit import ShowingFruit, CenteredFruit
    ...
    while True:
        ...
        if show_menu:
            ...
            #         active_fruits.remove(fruit)
                ...
                #     game_over_text = indicator_font.render("Game Over!", True, red)
                #     screen.blit(game_over_text, (screen_width // 2 - 100, screen_height // 2))
                #     pygame.display.update()
                    # time.sleep(5)  # Display "Game Over" message for 2 seconds
            ...
            if elapsed_time < session_duration and fruits_dropped < max_fruits_per_session:
                if random.randint(0, 100) < 5:  # Adjust the probability
                    active_fruits.append(showing_fruit)
                    fruits_dropped += 1
